...
export class CardService {
    ...
    // }
    async verifyBingo(matchId: string, cardId: string, userId: string): Promise<BingoResultDto> {
        ...
        const invalidNumbers = checkedNumbers.filter(num => !match.calledNumbers.includes(num));
